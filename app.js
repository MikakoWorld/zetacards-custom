...
function updateColorPreview(){if(!fontColorPreview)return;fontColorPreview.style.color=state.style.fontColor||'#23233a'}
...
if(fontFamilySelect)fontFamilySelect.addEventListener('change',e=>{state.style.fontFamily=e.target.value||'maru';persist();renderPreview()});
