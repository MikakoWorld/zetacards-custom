...
const state={activeTemplate:'profile',style:{fontColor:'#23233a'},question:{firstCharacter:'',featureRequest:'',reasonStarted:'',messageToOps:'',freeSpace:''},profile:{name:'',xId:'',zetaHistory:'',creatorId:'',nickname:'',favoriteThing:'',profileImage:'',oshi1Name:'',oshi2Name:'',oshi3Name:'',oshi1Desc:'',oshi2Desc:'',oshi3Desc:'',oshi1Image:'',oshi2Image:'',oshi3Image:''}};
...
if(fontColorInput)fontColorInput.addEventListener('input',e=>{state.style.fontColor=e.target.value||'#23233a';persist();renderPreview()});
